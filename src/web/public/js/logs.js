        ...
        <div class="report-shell">
          <section class="report-header">
            <div>
              ...
              <div class="report-author" style="font-size: 8px; background: rgba(255, 255, 255, 0.22); display: inline-block; padding: 2px 6px; border-radius: 6px; margin-top: 6px;">
                Generated by: ${escapeHtml(localStorage.getItem('first_name') + ' ' + localStorage.getItem('last_name') || 'Unknown')}
              </div>
            </div>
